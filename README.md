...
* [Here](https://imgur.com/a/MIFfD1Q) you can see an ugly plot showing the temperature sensor, CPU temperature, GPU temperature, CPU package power, CPU fan speed (above motherboard), Chassis1 fan speed (above PSU), GPU Fan1, and GPU power for all 11 configurations over time, for each test.  
